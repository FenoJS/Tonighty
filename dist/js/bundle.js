...
/***/ "./src/images/cast-placeholder.jpg":
/*!*****************************************!*\
  !*** ./src/images/cast-placeholder.jpg ***!
  \*****************************************/
/*! no static exports found */
...
eval("module.exports = __webpack_require__.p + \"img/a0806580895920f5086c64c7559d157b.jpg\";\n\n//# sourceURL=webpack:///./src/images/cast-placeholder.jpg?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Favorites = function () {\n  function Favorites() {\n    _classCallCheck(this, Favorites);\n\n    this.favoriteShows = [];\n    this.favoriteEpisodes = [];\n  }\n\n  _createClass(Favorites, [{\n    key: 'isLiked',\n    value: function isLiked(id, type) {\n      if (type === 'show') {\n        return this.favoriteShows.findIndex(function (e) {\n          return e.id === id;\n        }) !== -1;\n      }\n      if (type === 'episode') {\n        return this.favoriteEpisodes.findIndex(function (e) {\n          return e === id;\n        }) !== -1;\n      }\n    }\n  }, {\n    key: 'addFavorite',\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(item, type) {\n        var _favoriteEpisodes;\n\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                if (!(type === 'show')) {\n                  _context.next = 7;\n                  break;\n                }\n\n                _context.t0 = this.favoriteShows;\n                _context.next = 4;\n                return Favorites.getAirdate(item);\n\n              case 4:\n                _context.t1 = _context.sent;\n\n                _context.t0.push.call(_context.t0, _context.t1);\n\n                console.log('1');\n\n              case 7:\n                if (type === 'episode') {\n                  if (Array.isArray(item)) {\n                    (_favoriteEpisodes = this.favoriteEpisodes).push.apply(_favoriteEpisodes, _toConsumableArray(item));\n                  } else {\n                    this.favoriteEpisodes.push(item);\n                  }\n                }\n\n                // Persist data in localStorage\n                this.persistData(type);\n\n              case 9:\n              case 'end':\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      function addFavorite(_x, _x2) {\n        return _ref.apply(this, arguments);\n      }\n\n      return addFavorite;\n    }()\n  }, {\n    key: 'refreshShowsAirdate',\n    value: function () {\n      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {\n        var _this = this;\n\n        return regeneratorRuntime.wrap(function _callee3$(_context3) {\n          while (1) {\n            switch (_context3.prev = _context3.next) {\n              case 0:\n                this.favoriteShows.map(function () {\n                  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(i) {\n                    var showData, index, updatedShowAirdate;\n                    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                      while (1) {\n                        switch (_context2.prev = _context2.next) {\n                          case 0:\n                            if (!(i.airdateInfo && new Date(i.airdateInfo.airstamp).getTime() < new Date().getTime())) {\n                              _context2.next = 10;\n                              break;\n                            }\n\n                            _context2.next = 3;\n                            return (0, _axios2.default)('https://api.tvmaze.com/shows/' + i.id);\n\n                          case 3:\n                            showData = _context2.sent;\n                            index = _this.favoriteShows.indexOf(i);\n                            _context2.next = 7;\n                            return Favorites.getAirdate(showData.data);\n\n                          case 7:\n                            updatedShowAirdate = _context2.sent;\n\n                            _this.favoriteShows[index].airdateInfo = updatedShowAirdate.airdateInfo;\n                            _this.persistData('show');\n\n                          case 10:\n                          case 'end':\n                            return _context2.stop();\n                        }\n                      }\n                    }, _callee2, _this);\n                  }));\n\n                  return function (_x3) {\n                    return _ref3.apply(this, arguments);\n                  };\n                }());\n\n              case 1:\n              case 'end':\n                return _context3.stop();\n            }\n          }\n        }, _callee3, this);\n      }));\n\n      function refreshShowsAirdate() {\n        return _ref2.apply(this, arguments);\n      }\n\n      return refreshShowsAirdate;\n    }()\n  }, {\n    key: 'deleteFavorite',\n    value: function deleteFavorite(id, type) {\n      var _this2 = this;\n\n      if (type === 'show') {\n        var index = this.favoriteShows.findIndex(function (el) {\n          return el.id === id;\n        });\n        this.favoriteShows.splice(index, 1);\n      }\n      if (type === 'episode') {\n        if (Array.isArray(id)) {\n          id.map(function (i) {\n            var index = _this2.favoriteEpisodes.indexOf(i);\n            return _this2.favoriteEpisodes.splice(index, 1);\n          });\n        } else {\n          var _index = this.favoriteEpisodes.findIndex(function (el) {\n            return el === id;\n          });\n          this.favoriteEpisodes.splice(_index, 1);\n        }\n      }\n\n      // Persist data in localStorage\n      this.persistData(type);\n    }\n  }, {\n    key: 'persistData',\n    value: function persistData(type) {\n      if (type === 'show') {\n        localStorage.setItem('favoriteShows', JSON.stringify(this.favoriteShows));\n      }\n      if (type === 'episode') {\n        localStorage.setItem('favoriteEpisodes', JSON.stringify(this.favoriteEpisodes));\n      }\n    }\n  }, {\n    key: 'readStorage',\n    value: function readStorage() {\n      var storageShows = JSON.parse(localStorage.getItem('favoriteShows'));\n      var storageEpisodes = JSON.parse(localStorage.getItem('favoriteEpisodes'));\n\n      // Restore likes from the localStorage\n      if (storageShows) this.favoriteShows = storageShows;\n      if (storageEpisodes) this.favoriteEpisodes = storageEpisodes;\n    }\n  }], [{\n    key: 'getAirdate',\n    value: function () {\n      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(show) {\n        var airdate;\n        return regeneratorRuntime.wrap(function _callee4$(_context4) {\n          while (1) {\n            switch (_context4.prev = _context4.next) {\n              case 0:\n                _context4.prev = 0;\n\n                if (!(show._links && show._links.nextepisode)) {\n                  _context4.next = 7;\n                  break;\n                }\n\n                _context4.next = 4;\n                return (0, _axios2.default)(show._links.nextepisode.href.replace('http', 'https'));\n\n              case 4:\n                airdate = _context4.sent;\n\n                show.airdateInfo = airdate.data;\n                return _context4.abrupt('return', show);\n\n              case 7:\n                return _context4.abrupt('return', show);\n\n              case 10:\n                _context4.prev = 10;\n                _context4.t0 = _context4['catch'](0);\n\n                console.log(_context4.t0);\n\n              case 13:\n              case 'end':\n                return _context4.stop();\n            }\n          }\n        }, _callee4, this, [[0, 10]]);\n      }));\n\n      function getAirdate(_x4) {\n        return _ref4.apply(this, arguments);\n      }\n\n      return getAirdate;\n    }()\n  }]);\n\n  return Favorites;\n}();\n\nexports.default = Favorites;\n\n//# sourceURL=webpack:///./src/js/models/Favorites.js?");

/***/ }),

/***/ "./src/js/models/Popular.js":
/*!**********************************!*\
  !*** ./src/js/models/Popular.js ***!
  \**********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Search = function () {\n  function Search(query) {\n    _classCallCheck(this, Search);\n\n    this.query = query;\n  }\n\n  _createClass(Search, [{\n    key: 'getResult',\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var res;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.prev = 0;\n                _context.next = 3;\n                return (0, _axios2.default)('https://api.tvmaze.com/search/shows?q=' + this.query);\n\n              case 3:\n                res = _context.sent;\n\n                this.result = res.data.map(function (item) {\n                  return item.show;\n                });\n                _context.next = 10;\n                break;\n\n              case 7:\n                _context.prev = 7;\n                _context.t0 = _context['catch'](0);\n\n                console.log(_context.t0);\n\n              case 10:\n              case 'end':\n                return _context.stop();\n            }\n          }\n        }, _callee, this, [[0, 7]]);\n      }));\n\n      function getResult() {\n        return _ref.apply(this, arguments);\n      }\n\n      return getResult;\n    }()\n  }]);\n\n  return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/models/Search.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderCasts = exports.renderCast = undefined;\n\nvar _castPlaceholder = __webpack_require__(/*! ../../images/cast-placeholder.jpg */ \"./src/images/cast-placeholder.jpg\");\n\nvar _castPlaceholder2 = _interopRequireDefault(_castPlaceholder);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar renderCast = exports.renderCast = function renderCast(cast) {\n  var el = document.querySelector('.show__cast-box');\n  var markup = '\\n    <div class=\"cast\">\\n      <img src=\"' + (cast.character.image ? cast.character.image.medium.replace('http', 'https') : _castPlaceholder2.default) + '\" alt=\"\" class=\"cast__img\"/>\\n      <div class=\"cast__info\">\\n        <span class=\"cast__character\">' + cast.character.name + '</span>\\n        <span class=\"cast__actor\">(' + cast.person.name + ')</span>\\n      </div>\\n    </div>\\n  ';\n  el.insertAdjacentHTML('beforeend', markup);\n};\n\nvar renderCasts = exports.renderCasts = function renderCasts(casts) {\n  casts.forEach(function (cast) {\n    return renderCast(cast);\n  });\n};\n\n//# sourceURL=webpack:///./src/js/views/castView.js?");

/***/ }),

/***/ "./src/js/views/episodesView.js":
/*!**************************************!*\
  !*** ./src/js/views/episodesView.js ***!
  \**************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderEpisodes = undefined;\n\nvar _dayjs = __webpack_require__(/*! dayjs */ \"./node_modules/dayjs/dayjs.min.js\");\n\nvar _dayjs2 = _interopRequireDefault(_dayjs);\n\nvar _relativeTime = __webpack_require__(/*! dayjs/plugin/relativeTime */ \"./node_modules/dayjs/plugin/relativeTime.js\");\n\nvar _relativeTime2 = _interopRequireDefault(_relativeTime);\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar _helpers = __webpack_require__(/*! ../helpers */ \"./src/js/helpers.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n_dayjs2.default.extend(_relativeTime2.default);\n\nfunction renderLikedBtn(id, storage) {\n  if (storage) {\n    return storage.findIndex(function (e) {\n      return e === id;\n    }) !== -1;\n  }\n}\n\nvar renderEpisode = function renderEpisode(episode, season, storage) {\n  if (episode.season === season) {\n    var relativeAirdate = episode.airstamp ? (0, _dayjs2.default)().to((0, _dayjs2.default)(episode.airstamp)) : '';\n    var id = episode.id;\n\n    var buttonText = renderLikedBtn(id, storage) ? 'Watched' : 'Unwatched';\n    var el = document.querySelector('.show__episodes-box');\n\n    var markup = '<div class=\"episode\">\\n      <div class=\"episode__img-box\">\\n      <picture>\\n        <source media=\"(max-width: 600px)\"\\n          sizes=\"1px\"\\n          srcset=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 1w\"/>\\n        <img src=\"' + (episode.image ? episode.image.medium.replace('http', 'https') : '') + '\" alt=\"\" class=\"episode__img\"/>\\n      </picture>\\n      </div>\\n      <div class=\"episode__details\">\\n        <span class=\"episode__info\">S' + (0, _helpers.formatEpisodeNum)(episode.season) + 'E' + (0, _helpers.formatEpisodeNum)(episode.number) + ' - ' + episode.name + '</span>\\n        <span class=\"episode__airdate\">Airdate: ' + episode.airdate + ' ' + episode.airtime + ' - ' + relativeAirdate + '</span>\\n      </div>\\n      <div class=\"episode__buttons\">\\n        <button class=\"btn btn__fav ' + (renderLikedBtn(id, storage) ? 'btn__fav--watched btn__fav--watched2' : 'btn__fav--watched') + '\" data-episode-id=\"' + episode.id + '\">' + buttonText + '</button>\\n      </div>\\n    </div>';\n    el.insertAdjacentHTML('beforeend', markup);\n  }\n};\n\nvar renderEpisodes = exports.renderEpisodes = function renderEpisodes(episodes, season) {\n  var storage = JSON.parse(localStorage.getItem('favoriteEpisodes'));\n\n  var el = document.querySelector('.' + _base.elementString.episodesList);\n  el.innerHTML = '<button class=\"btn btn__fav btn__fav--watch-all\">Watch all</button>\\n                  <button class=\"btn btn__fav btn__fav--unwatch-all\">Uwatch all</button>';\n  episodes.forEach(function (episode) {\n    return renderEpisode(episode, season, storage);\n  });\n};\n\n//# sourceURL=webpack:///./src/js/views/episodesView.js?");

/***/ }),

/***/ "./src/js/views/scheduleView.js":
/*!**************************************!*\
  !*** ./src/js/views/scheduleView.js ***!
  \**************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderUpcoming = exports.clearUpcoming = undefined;\n\nvar _dayjs = __webpack_require__(/*! dayjs */ \"./node_modules/dayjs/dayjs.min.js\");\n\nvar _dayjs2 = _interopRequireDefault(_dayjs);\n\nvar _relativeTime = __webpack_require__(/*! dayjs/plugin/relativeTime */ \"./node_modules/dayjs/plugin/relativeTime.js\");\n\nvar _relativeTime2 = _interopRequireDefault(_relativeTime);\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar _helpers = __webpack_require__(/*! ../helpers */ \"./src/js/helpers.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n_dayjs2.default.extend(_relativeTime2.default);\n\nvar renderShow = function renderShow(show) {\n  console.log('redner upcomong item', show);\n  var el = document.querySelector('.' + _base.elementString.upcomingBarList);\n  if (show.airdateInfo) {\n    var markup = '<li class=\"upcoming-bar__item\">\\n        <div class=\"upcoming-bar__info\">\\n          ' + show.name + ' S' + (0, _helpers.formatEpisodeNum)(show.airdateInfo.season) + 'E' + (0, _helpers.formatEpisodeNum)(show.airdateInfo.number) + '\\n        </div>\\n        <div class=\"upcoming-bar__date\">\\n          ' + show.airdateInfo.airdate + ' ' + (0, _dayjs2.default)().to((0, _dayjs2.default)(show.airdateInfo.airstamp)) + '\\n        </div>\\n      </li>';\n\n    el.insertAdjacentHTML('beforeend', markup);\n  }\n  if (show.status !== 'Running') {\n    var _markup = '<li class=\"upcoming-bar__item\">\\n      <div class=\"upcoming-bar__info\">\\n        ' + show.name + '\\n      </div>\\n      <div class=\"upcoming-bar__date\">\\n        ' + show.status + '\\n      </div>\\n    </li>';\n\n    el.insertAdjacentHTML('beforeend', _markup);\n  }\n\n  if (show.status === 'Running' && !show.airdateInfo) {\n    var _markup2 = '<li class=\"upcoming-bar__item\">\\n    <div class=\"upcoming-bar__info\">\\n      ' + show.name + '\\n    </div>\\n    <div class=\"upcoming-bar__date\">\\n      Waiting for info\\n    </div>\\n  </li>';\n\n    el.insertAdjacentHTML('beforeend', _markup2);\n  }\n};\n\nvar clearUpcoming = exports.clearUpcoming = function clearUpcoming() {\n  _base.elements.upcomingBar.innerHTML = '';\n};\n\nvar renderUpcoming = exports.renderUpcoming = function renderUpcoming(shows) {\n\n  if (!shows.length > 0) {\n    var markupEmpty = '<span class=\"upcoming-bar__empty\">Add TV shows to favorites to see countdown</span>';\n    _base.elements.upcomingBar.insertAdjacentHTML('beforeend', markupEmpty);\n  } else {\n    var markup = '<h3 class=\"upcoming-bar__header\" >upcoming shows: </h3>\\n                    <ul class=\"' + _base.elementString.upcomingBarList + ' \"></ul>';\n    _base.elements.upcomingBar.insertAdjacentHTML('beforeend', markup);\n    shows.forEach(renderShow);\n  }\n};\n\n//# sourceURL=webpack:///./src/js/views/upcomingBarView.js?");
